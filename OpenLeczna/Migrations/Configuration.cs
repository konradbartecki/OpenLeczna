...
namespace OpenLeczna.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<OpenLeczna.Models.TransportServiceContext>
    {
        ...
        protected override void Seed(OpenLeczna.Models.TransportServiceContext context)
        {
            ...
            context.Carriers.AddOrUpdate(x => x.Name,
                new Carrier()
                {
                    Id = 0,
                    Name = "£êcz-Trans"
            ...
            context.Stations.AddOrUpdate(x => x.Name,
                            new Station()
                            {
                                ...
                                Schedules = new List<Schedule>()
                                    ...
                                    new Schedule()
                                        {
                                            CarrierName = "£êcz-Trans",
                                            DestinationCity = "Lublin",
                                            ApplicableDays = "Weekdays",
                                            StationName = "Dworzec (Wamex)",
